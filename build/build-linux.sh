#!/bin/bash
# build-linux.sh — Build PezMax for Linux
# Output: tar.gz archive with executable + libpdfium.so + launcher script
...
echo "============================================"
echo "  PezMax Linux Build ($PDF_PLATFORM)"
echo "============================================"
...
# Create launcher script: pdfium-render uses libloading to load libpdfium.so
# at runtime, so LD_LIBRARY_PATH must include the directory containing it.
